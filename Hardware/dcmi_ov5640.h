...
#define Camera_Buffer	0x30000000    // 摄像头图像缓冲区
...
#define 	OV5640_Width          640   // ISP输出(4:3 VGA)
#define 	OV5640_Height         480   // ISP输出(4:3 VGA)
...
#define OV5640_PWDN_PIN            			 PWDN_Pin        				 	// PWDN 引脚
#define OV5640_PWDN_PORT           			 PWDN_GPIO_Port                 			 	// PWDN GPIO端口

// 高电平，不开启掉电模式，摄像头正常工作
#define	OV5640_PWDN_OFF	HAL_GPIO_WritePin(OV5640_PWDN_PORT, OV5640_PWDN_PIN, GPIO_PIN_SET)

// 低电平，进入掉电模式，摄像头停止工作，此时功耗降到最低
#define 	OV5640_PWDN_ON		HAL_GPIO_WritePin(OV5640_PWDN_PORT, OV5640_PWDN_PIN, GPIO_PIN_RESET)
